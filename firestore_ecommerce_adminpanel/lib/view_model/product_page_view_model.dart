...
class ProductPageViewModel with ChangeNotifier {
  ...
  ProductPageViewModel({required this.categoryId}) {
  ...
  void getData() async {
    _stream = await _repository.getProductData(categoryId: categoryId);
  ...
  updateData(BuildContext context, int index) async{
    ...
    if(result != null){
      ...
      await _repository.updateProduct(productModel: productModel, categoryId: categoryId, newProductName: newProductName, newProductImage: newProductImage, newProductPrice: price);
  ...
  deleteData(int index) async{
    ProductModel productModel = _products[index];
    await _repository.deleteProduct(productModel: productModel, categoryId: categoryId);
  }
